...
const Footer = () => {
	...
	const serviceLinks = [
		{ name: t("footer.servicesList.webDesign"), href: "#" },
		{ name: t("footer.servicesList.uiux"), href: "#" },
		{ name: t("footer.servicesList.webDevelopment"), href: "#" },
		{ name: t("footer.servicesList.wordpress"), href: "#" },
		{ name: t("footer.servicesList.consulting"), href: "#" },
	];
