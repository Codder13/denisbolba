...
const useSkills = (t) => [
	{
		name: t("skills.skillsList.webDesign"),
		percentage: 95,
		color: "from-blue-400 to-indigo-500",
	},
	{
		name: t("skills.skillsList.uiux"),
		percentage: 90,
		color: "from-purple-400 to-pink-500",
	},
	{
		name: t("skills.skillsList.html"),
		percentage: 98,
		color: "from-orange-400 to-red-500",
	},
	{
		name: t("skills.skillsList.javascript"),
		percentage: 85,
		color: "from-yellow-400 to-amber-500",
	},
	{
		name: t("skills.skillsList.react"),
		percentage: 80,
		color: "from-cyan-400 to-blue-500",
	},
	{
		name: t("skills.skillsList.next"),
		percentage: 85,
		color: "from-indigo-400 to-violet-500",
	},
	{
		name: t("skills.skillsList.wordpress"),
		percentage: 100,
		color: "from-teal-400 to-cyan-500",
	},
	{
		name: t("skills.skillsList.figma"),
		percentage: 90,
			...
			<div className="container mx-auto px-4 relative z-10">
				...
				>
					...
					>
						...
						>
							{t("skills.services.webDesign.title")}
						</motion.h3>

						<p className="text-gray-400 mb-4 group-hover:text-gray-300 transition-colors duration-300">
							{t("skills.services.webDesign.description")}
						</p>
					...
					>
						...
						<motion.h3
							...
							transition={{ type: "spring", stiffness: 300 }}
						>
							{t("skills.services.uiux.title")}
						</motion.h3>

						<p className="text-gray-400 mb-4 group-hover:text-gray-300 transition-colors duration-300">
							{t("skills.services.uiux.description")}
						</p>
					...
					>
						...
						<motion.h3
							...
							transition={{ type: "spring", stiffness: 300 }}
						>
							{t("skills.services.development.title")}
						</motion.h3>

						<p className="text-gray-400 mb-4 group-hover:text-gray-300 transition-colors duration-300">
							{t("skills.services.development.description")}
						</p>
				...
				>
					<div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
						...
						<div className="text-sm text-gray-400">
							{t("skills.stats.yearsExperience")}
						</div>
					</div>
					...
					<div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
						...
						<div className="text-sm text-gray-400">
							{t("skills.stats.projectsCompleted")}
						</div>
					</div>
