		...
		>
			...
			<div className="container mx-auto px-4 z-10 relative">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					<div className="flex flex-col items-center lg:items-start text-center lg:text-left">
						...
						>
							<span className="text-white block">{t("hero.greeting")} </span>
						...
						>
							...
							>
								<span className="relative z-10">{t("hero.role1")}</span>
							...
							<motion.span
								...
								whileHover={{ scale: 1.05 }}
							>
								<span className="relative z-10">{t("hero.role2")}</span>
							...
							<motion.span
								...
								whileHover={{ scale: 1.05 }}
							>
								<span className="relative z-10">{t("hero.location")}</span>
								<span className="absolute inset-0 rounded-full bg-secondary/5 blur-sm"></span>
							</motion.span>
						</motion.div>
						...
						>
							<span className="font-medium">{t("hero.description")}</span>{" "}
			...
			>
				<div className="flex flex-col items-center">
					<span className="text-white/50 text-sm mb-2">{t("hero.scroll")}</span>
