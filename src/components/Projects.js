...
const useProjectsData = (t) => [
	{
		id: 1,
		title: t("projects.projectsList.lavanda.title"),
		category: t("projects.projectsList.lavanda.category"),
		image: "/images/project-1.jpg",
		altText: "Lavanda Florarie - Premium flower shop website",
		description: t("projects.projectsList.lavanda.description"),
		technologies: ["Next.js", "Tailwind CSS", "Framer Motion", "WordPress"],
		link: "https://lavandaflorarie.com",
	},
	{
		id: 2,
		title: t("projects.projectsList.bella.title"),
		category: t("projects.projectsList.bella.category"),
		image: "/images/project-2.jpg",
		altText: "Bella Floraria - Modern florist e-commerce platform",
		description: t("projects.projectsList.bella.description"),
		technologies: ["React", "GSAP", "Styled Components", "WordPress"],
		link: "https://bellafloraria.ro",
	},
	{
		id: 3,
		title: t("projects.projectsList.biciclete.title"),
		category: t("projects.projectsList.biciclete.category"),
		image: "/images/project-3.jpg",
		altText: "Biciclete Copii - Children's bicycle store",
		description: t("projects.projectsList.biciclete.description"),
...
const useCategories = (t) => [
	...
	t("projects.categories.webDesign"),
	t("projects.categories.uiux"),
	t("projects.categories.webApp"),
	t("projects.categories.wordpress"),
...
const Projects = () => {
	...
	// Set the default active category to the first one (All) when categories are loaded
	const currentActiveCategory = activeCategory || categories[0];

	const filteredProjects =
		currentActiveCategory === categories[0]
			? projectsData
			: projectsData.filter(
					(project) => project.category === currentActiveCategory,
				);
